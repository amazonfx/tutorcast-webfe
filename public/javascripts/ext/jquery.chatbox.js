    ...
    $.widget("ui.chatbox", {
        options: {
            ...
            boxManager: {
                ...
                addMsg: function(peer, msg, shake) {
                    ...
                    if (!$j('.ui-chatbox-input-box').is(':visible') && shake){
                    	var count = parseInt($j('#pending-count').text());
                    	++count
                    	$j('#pending-count').text(count+'');
                    	$j('.pending-chats').show();
...
//                        });
        ...
        _create: function(){
            ...
            uiChatboxTitle = (self.uiChatboxTitle = $('<div class="pending-chats"><span id="pending-count">0</span></div>'))
            .appendTo(uiChatboxTitlebar),
